 ...
 .masthead.h-auto.mh-auto
  ...
  section#about.about-section.text-center.bg-location
    .container.container--wide
      ...
      p.pagination
        a.pagination__next(href='page2.html') Next page
      ...
      .modal-content
        .modal-header
          h3#exampleModalLabel.modal-title
            | 台灣
            small.text-primary.ml-2 明森宇治抹茶。咖啡手作（大安森林店）
          ...
          .row.align-items-center.no-gutters
            ...
            .col-xl-5.col-lg-5
              .featured-text.text-lg-left.ml-3
                p.text-black-50
                  | 不知道是否需要一些文字不知道是否需要一些文字不知道是否需要一些文字不知道是否需要一些文字不知道是否需要一些文字不知道是否需要一些文字不知道是否需要一些文字不知道是否需要一些文字不知道是否需要一些文字不知道是否需要一些文
                ol.list-unstyled
                  li
                    | 電話：
                    span.text-black-50 02 2555 5785
                  li
                    | 地址：
                    span.text-black-50 106 台北市大安區新生南路 二段30巷1-2號
